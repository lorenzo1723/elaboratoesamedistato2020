...
/**
 * Pop up che verrà mostrato se il riconoscitore facciale troverà una o più facce
 *
 * @author lorenzo
 */
public class FaceResultDialog extends DialogFragment {
    /**
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        // Creo la View
        View view = inflater.inflate(R.layout.face_detection_result_dialog, container, false);

        backButton = view.findViewById(R.id.result_ok_button);
        resultTextView = view.findViewById(R.id.result_text_view);

        // Creo un bundle per memorizzare i risultati
        Bundle bundle = getArguments();
        String result = bundle.getString(FaceDetectionBundleUtils.REQUEST_TEXT);
